"""
Streamlit app for RAG Writing Assistant

This is a simplified, self-contained Streamlit app for the RAG Writing Assistant.
It's designed to be easily deployed to Streamlit Cloud.
"""
...
def initialize_assistant():
    ...
    try:
        ...
        # Get API keys from session state or secrets
        ...
        if not anthropic_api_key and 'api_keys' in st.secrets:
